...
public class DataSource {
    ...
    private static @NotNull ItemStack getDefaultPlayerHead() {
        ItemStack defaultHead = XMaterial.PLAYER_HEAD.parseItem();
        ...
        if (skullMeta != null && textureValue != null && !textureValue.isEmpty()) {
            ...
            try {
                ...
                if (XMaterial.supports(9)) {
                    ...
                    skullMeta = SkullUtils.applySkin(skullMeta, textureValue);
                }
                ...
                return XMaterial.PLAYER_HEAD.parseItem(); // Fallback to default head on failure
            }
        }
